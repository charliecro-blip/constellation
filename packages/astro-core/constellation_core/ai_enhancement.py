...
- Rewrite substantially rather than lightly polishing the deterministic text.
- Remove engine labels such as "Additional," "Central," or "Moderate" when they appear as standalone pattern-weight language.
- Smooth or replace visible engine phrasing such as "The listed bodies," "axis describes," or "The planet person may appear as" with natural relational prose.
