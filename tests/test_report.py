...
def test_synthesis_packet_contains_ranked_patterns_and_lead_pattern():
    ...
    packet = report.synthesis_packet
    ...
    assert packet.top_ranked_patterns[0].why_it_matters
...
def test_ai_enhancement_user_prompt_embeds_synthesis_packet_priority_order():
    ...
    from constellation_core.report import RankedPatternSummary, ReportSynthesisPacket
